...
void MBConvBlock6(
    ...
    // expand_conv
    int* expand_conv_out_size = (int*)malloc(sizeof(int)*4);
    expand_conv_out_size[0] = 1;
    expand_conv_out_size[1] = in_channels*6;
    expand_conv_out_size[2] = input_size;
    expand_conv_out_size[3] = input_size;
    sprintf(str, "%s%s", prefix, "._expand_conv.weight");
    printf("%s\n", str);
    conv2d_layer_t* expand_conv = Conv2d(in_channels, in_channels*6, 0, 1, 1, 0, 0, 0, 0, get_param_from_name(str));
    ...
    depthwise_conv_out_size[1] = in_channels*6;
    ...
    conv2d_layer_t* depthwise_conv = Conv2d(in_channels*6, in_channels*6, 0, dw_kernel, dw_stride, dw_pad_top, dw_pad_bottom, dw_pad_right, dw_pad_left, get_param_from_name(str));
    ...
    conv2d_layer_t* se_reduce = Conv2d_bias(in_channels*6, in_channels/4, 0, 1, 1, 0, 0, 0, 0, 
        get_param_from_name(str),
        get_param_from_name(str2));
    ...
    se_expand_out_size[1] = in_channels*6;
    ...
    conv2d_layer_t* se_expand = Conv2d_bias(in_channels/4, in_channels*6, 0, 1, 1, 0, 0, 0, 0, 
        get_param_from_name(str),
        get_param_from_name(str2));
    ...
    conv2d_layer_t* project_conv = Conv2d(in_channels*6, out_channels, 0, 1, 1, 0, 0, 0, 0, 
        get_param_from_name(str));
    ...
    block->output_size = project_conv_out_size[2];
